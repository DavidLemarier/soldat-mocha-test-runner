...
import SoldatHtmlReporterComponent from './components/soldat-html-reporter-component'
...
module.exports = class SoldatHtmlReporter {
  ...
  render () {
    const props = {
      title: this.options.title || "Soldat Test Runner",
  ...
  buildComponent (props) {
    ...
    container.setAttribute('id', 'soldat-mocha-test-runner')
    const shadow = container.createShadowRoot()
    document.body.appendChild(container)
    const component = new SoldatHtmlReporterComponent(props)
  ...
  prepareDocument (props) {
    ...
    const soldatStylesTag = document.querySelector('soldat-styles')
    if (soldatStylesTag) soldatStylesTag.remove()
